...
export const updateProduct = (req,res) =>{
  try {
    ...
    res.status(503).json({message:"Cannot update the product , Error in update product"});
  }
}
...
export const deleteProduct = (req,res)=>{
  try {
    ...
    res.status(503).json({message:"Cannot delete the product,Error in delete product"});
  }
}